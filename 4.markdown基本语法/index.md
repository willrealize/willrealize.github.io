...
```markdown
![Minion](https://pic.imgdb.cn/item/629a49d0094754312954f81f.png)
```
...
```markdown
![Alt text](https://pic.imgdb.cn/item/629a49e7094754312955183e.png "The Stormtroopocat")
```
...
```markdown
[id]: https://pic.imgdb.cn/item/629a49c8094754312954ec8e.jpg  "The Dojocat"
```
